...
def get_pipeline():
    """Dependency to get the rotation pipeline"""
    global pipeline
    if pipeline is None:
        ...
        try:
            ...
            logger.info("Profile rotation pipeline initialized successfully")
...
def get_visualizer():
    ...
    if visualizer is None:
        visualizer = ProfileRotationVisualizer()
    return visualizer
...
async def startup_event():
    ...
    try:
        ...
        get_image_processor()
        get_visualizer()
        logger.info("Profile rotation API startup completed successfully")
    except Exception as e:
